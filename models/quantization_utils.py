...
class QuantizationConfig:
    ...
    def get_layer_config(self, layer_name: str) -> Optional[Dict]:
...
class ModelQuantizer:
    ...
    def quantize_model(self, model: nn.Module) -> nn.Module:
        ...
        # Log statistics
        compression_ratio = total_params / max(1, quantized_params) if quantized_params > 0 else 1.0
        logger.info(
        ...
        for child_name, child in module.items():
            ...
            if isinstance(child, nn.Linear):
                ...
                if self._should_quantize_layer(full_name):
                    ...
                    quantized_params += param_count * self._get_layer_bits(full_name) // 32
    ...
    def _should_quantize_layer(self, layer_name: str) -> bool:
        ...
        if ("lm_head" in layer_name.lower() or "output" in layer_name.lower()) and not self.config.quantize_output_layer:
            return False
