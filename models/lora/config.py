...
class LoRAConfig:
    ...
    modules_to_save: Set[str] = field(default_factory=lambda: {
        "classifier", "regression_head", "pooler"
    })
    ...
    layer_specific_config: Dict[str, Dict[str, Union[int, float]]] = field(default_factory=dict)
    
    def get_layer_config(self, layer_name: str) -> Dict[str, Union[int, float]]:
...
class QLoRAConfig(LoRAConfig):
    ...
    max_memory_mb: Optional[int] = None  # Set to limit GPU memory usage
...
class LoRATrainingConfig:
    ...
    layer_wise_lr_decay: Optional[float] = None
...
def get_lora_preset(name: str) -> Union[LoRAConfig, QLoRAConfig]:
