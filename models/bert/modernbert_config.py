...
class ModernBertConfig(BertConfig):
    ...
    # GeGLU configuration
    use_geglu: bool = True
    geglu_limit: Optional[float] = None  # Optional limit for GeGLU gate values
    ...
    def __post_init__(self):
        ...
        if self.model_size == "base" and self.hidden_size == 768 and self.num_hidden_layers == 12:
        ...
        elif self.model_size == "large" and self.hidden_size == 1024 and self.num_hidden_layers == 24:
    ...
    @classmethod
    def from_pretrained(cls, model_path: Union[str, Path]) -> "ModernBertConfig":
