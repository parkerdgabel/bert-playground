...
class BinaryClassificationHead(BaseHead):
    ...
    def __init__(self, config: Union[ClassificationConfig, HeadConfig]):
    ...
    def _build_output_layer(self):
        ...
        # Single output unit
        self.classifier = nn.Linear(self.projection_output_size, 1, bias=self.config.use_bias)
    ...
    def compute_loss(
        ...
        **kwargs
        ...
        if self.loss_fn is not None:
            ...
            return cross_entropy_loss(logits, targets, num_classes=self.config.output_size)
...
def create_classification_head(
    config: Union[ClassificationConfig, HeadConfig],
