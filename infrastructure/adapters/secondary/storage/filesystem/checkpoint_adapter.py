...
from infrastructure.adapters.secondary.storage.base import BaseCheckpointAdapter
from infrastructure.adapters.secondary.storage.filesystem.storage_adapter import FilesystemStorageAdapter
from infrastructure.adapters.secondary.storage.filesystem.utils import (
    save_mlx_model,
    load_mlx_model,
