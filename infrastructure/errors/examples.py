...
from infrastructure.errors import ErrorGroup
...
from infrastructure.errors import CLIError
...
import logging
from infrastructure.errors import handle_error, register_type_handler
