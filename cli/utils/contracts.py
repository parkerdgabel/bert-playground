...
def validate_contract(
    ...
    deprecated_params: Optional[Dict[str, DeprecatedParameter]] = None
) -> Callable:
...
def enforce_api_version(min_version: str, max_version: Optional[str] = None) -> Callable:
...
class KaggleCompetitionContract(ParameterContract):
    ...
    id: str
    title: str
    deadline: Union[str, Any]  # Can be string or pd.Timestamp
    numTeams: int
