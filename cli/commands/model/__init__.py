...
model_app.command("list", help="List available models and checkpoints")(list_models_command)
model_app.command("inspect", help="Inspect model architecture and parameters")(inspect_command)
