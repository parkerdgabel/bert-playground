...
from .submit import auto_submit_command, submit_command
...
kaggle_app.command("competitions", help="List and search Kaggle competitions")(
    competitions_command
)
kaggle_app.command("datasets", help="List and search Kaggle datasets")(datasets_command)
kaggle_app.command("download", help="Download competition data")(
    download_competition_command
)
kaggle_app.command("download-dataset", help="Download a specific dataset")(
    download_dataset_command
)
kaggle_app.command("submit", help="Submit predictions to a competition")(submit_command)
kaggle_app.command("auto-submit", help="Generate and submit predictions automatically")(
    auto_submit_command
)
kaggle_app.command("leaderboard", help="View competition leaderboard")(
    leaderboard_command
)
