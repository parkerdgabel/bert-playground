...
@handle_errors
def test_command(
    components: Optional[List[str]] = typer.Option(None, "--component", "-c", help="Specific components to test"),
    ...
    report: Optional[Path] = typer.Option(None, "--report", "-r", help="Save test report to file"),
    ...
    test_table = create_table(
        "Test Results",
        ["Component", "Test", "Status", "Duration", "Details"]
    )
