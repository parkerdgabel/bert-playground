...
def demo_auto_detection():
    ...
    print(
        "Usage: create_universal_loader(train_path='data.csv', target_column='target')"
    )
...
def demo_custom_configuration():
    ...
    print(
        f"  - Features: {len(custom_spec.categorical_columns + custom_spec.numerical_columns)} total"
    )
