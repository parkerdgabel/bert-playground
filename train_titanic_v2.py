...
from utils.logging_config import setup_logging, ExperimentLogger
...
def main():
    ...
    if args.do_train:
        ...
        console.print(f"MLflow tracking: {'Enabled' if not args.disable_mlflow else 'Disabled'}")
        ...
        try:
            ...
            if args.do_predict and not args.checkpoint_path:
                args.checkpoint_path = str(Path(args.output_dir) / "best_model_accuracy")
    ...
    if args.do_visualize:
        ...
        try:
            ...
            report_path = visualizer.create_experiment_report(
