...
class StreamingPipeline:
    ...
    def start(self) -> None:
        ...
        self._batch_thread = threading.Thread(
            target=self._batch_worker, name="BatchWorker", daemon=True
        )
    ...
    def get_performance_stats(self) -> dict[str, Any]:
        ...
        return {
            ...
            "samples_per_second": self._samples_consumed / elapsed_time
            if elapsed_time > 0
            else 0,
            "batches_per_second": self._batches_created / elapsed_time
            if elapsed_time > 0
            else 0,
            "queue_sizes": {
            ...
            "active_threads": {
                ...
                "batch_worker": self._batch_thread.is_alive()
                if self._batch_thread
                else False,
            },
        }
    ...
    def get_buffer_info(self) -> dict[str, Any]:
        ...
        return {
            ...
            "buffer_utilization": self._sample_queue.qsize()
    ...
    def get_worker_statistics(self) -> list[dict[str, Any]]:
        ...
        if self._producer_threads:
            samples_per_worker = self._samples_produced // max(
                len(self._producer_threads), 1
            )
