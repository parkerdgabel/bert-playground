...
from .interfaces import DataLoader, Dataset, BatchProcessor, OptimizationProfile
...
class BaseMLXLoader:
    ...
    def __init__(
        ...
        optimization_profile: Optional[Union[str, OptimizationProfile]] = None,
    ...
    def _apply_optimization_profile(self, profile: Union[str, OptimizationProfile]) -> None:
    ...
    def _create_buffer_stream(self) -> None:
        ...
        if self.prefetch_size > 0:
            self._stream = self._stream.prefetch(
                self.prefetch_size,
                self.num_workers
            )
