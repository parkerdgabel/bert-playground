...
class DatasetRegistry:
    ...
    def __init__(self, registry_dir: Optional[Union[str, Path]] = None):
        ...
        """
        self.registry_dir = Path(registry_dir) if registry_dir else Path("data/registry")
        ...
        logger.info(f"Initialized DatasetRegistry with {len(self._competitions)} competitions")
    ...
    def register_competition(
        ...
        dataset_class: Optional[Type[KaggleDataset]] = None,
        ...
        try:
            ...
            if dataset_class:
                ...
                self._dataset_classes[normalized_name] = self._get_default_dataset_class(spec.competition_type)
    ...
    def get_competition(self, competition_name: str) -> Optional[CompetitionMetadata]:
    ...
    def get_dataset_spec(self, competition_name: str) -> Optional[DatasetSpec]:
    ...
    def get_competitions_by_type(self, competition_type: CompetitionType) -> List[str]:
        ...
        """
        return [
            name for name, metadata in self._competitions.items()
    ...
    def get_registry_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_samples_per_competition": total_samples / len(self._competitions) if self._competitions else 0,
            "avg_features_per_competition": total_features / len(self._competitions) if self._competitions else 0,
        }
    ...
    def discover_competitions(self, search_dir: Union[str, Path]) -> List[str]:
    ...
    def _get_default_dataset_class(self, competition_type: CompetitionType) -> Type[KaggleDataset]:
    ...
    def _load_registry(self) -> None:
        ...
        try:
            ...
            for name, spec_dict in data.get("dataset_specs", {}).items():
                spec_dict["competition_type"] = CompetitionType(spec_dict["competition_type"])
            ...
            for name in self._competitions:
                ...
                self._dataset_classes[name] = self._get_default_dataset_class(metadata.competition_type)
