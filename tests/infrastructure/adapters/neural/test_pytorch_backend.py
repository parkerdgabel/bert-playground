...
from infrastructure.adapters.neural.pytorch_backend import PyTorchNeuralBackend
from infrastructure.ports.neural import ActivationType, NeuralBackend, Module
...
class TestFrameworkInteroperability:
    ...
    def test_backend_protocol_compliance(self):
        ...
        from infrastructure.ports.neural import NeuralBackend
