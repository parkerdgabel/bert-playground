...
class TestUnifiedMemoryManager:
    ...
    def test_cross_device_memory(self, memory_config):
        ...
        tensor_cpu = manager.allocate_tensor(
            shape=(32, 32), dtype=mx.float32, device=mx.cpu
        )
    ...
    def test_memory_pooling_efficiency(self, memory_config):
        ...
        time_no_pool = measure_memory_allocation_time(allocate_fn, num_iterations=10)
        ...
        time_pool = measure_memory_allocation_time(allocate_pool_fn, num_iterations=10)
