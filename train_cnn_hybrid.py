...
def main():
    parser = argparse.ArgumentParser(
        description="Train CNN-Enhanced ModernBERT on Titanic dataset"
    )
    ...
    # Output arguments
    parser.add_argument(
        "--output-dir", default="./output/cnn_hybrid", help="Output directory"
    )
    parser.add_argument(
        "--experiment-name", default="titanic_cnn_hybrid", help="MLflow experiment name"
    )
    parser.add_argument(
        "--enable-mlflow",
        action="store_true",
