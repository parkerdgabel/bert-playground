...
class ModelCheckpoint(Callback):
    ...
    def on_evaluate_end(self, trainer: Trainer, state: TrainingState, metrics: dict) -> None:
    ...
    def _save_checkpoint(
        ...
        if is_best:
            ...
            name = f"{self.filename_prefix}_epoch_{state.epoch}_step_{state.global_step}"
