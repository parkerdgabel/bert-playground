...
class Callback(ABC):
    ...
    def on_checkpoint_load(self, trainer: Trainer, state: TrainingState, checkpoint_path: str) -> None:
    ...
    def on_evaluate_begin(self, trainer: Trainer, state: TrainingState) -> None:
        ...
        for callback in self.callbacks:
            try:
                ...
                logger.error(f"Error in {callback.__class__.__name__}.on_evaluate_begin: {e}")
    ...
    def on_evaluate_end(self, trainer: Trainer, state: TrainingState, metrics: Dict[str, float]) -> None:
        ...
        for callback in self.callbacks:
            try:
                ...
                logger.error(f"Error in {callback.__class__.__name__}.on_evaluate_end: {e}")
