...
class TitanicClassifierV2(nn.Module):
    ...
    def get_loss_info(self) -> Dict[str, Union[str, float]]:
        ...
        info = {"loss_type": self.loss_type, "is_adaptive": self.is_adaptive_loss}
...
def create_enhanced_classifier(
    ...
    **kwargs,
    ...
    default_configs = {
        "focal": {"dropout_prob": 0.1, "use_layer_norm": True, "activation": "gelu"},
        "weighted_ce": {
            "dropout_prob": 0.2,
            "use_layer_norm": True,
            "activation": "relu",
        ...
        "adaptive": {"dropout_prob": 0.1, "use_layer_norm": True, "activation": "gelu"},
    }
    ...
    logger.info(
        f"Created enhanced classifier with {loss_type} loss and config: {config}"
    )
